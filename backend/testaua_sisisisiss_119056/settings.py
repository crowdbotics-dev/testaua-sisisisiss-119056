"""
Django settings for testaua_sisisisiss_119056 project.
...
ROOT_URLCONF = 'testaua_sisisisiss_119056.urls'
...
WSGI_APPLICATION = 'testaua_sisisisiss_119056.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testaua_sisisisiss_119056 API",
    "DESCRIPTION": "API documentation for testaua_sisisisiss_119056 App",
    "VERSION": "v1",
}
